...
/**
 * @desc Denne komponenten blir rendret i todolist som et todo gjøremål. Den rendrer forskjellig basert på
 * om gjøremålet er gjennomført (blir grønn) eller om den ikke er gjennomført.
 *
 * @author Erik Larsen
 * @see todolist.js
 */
